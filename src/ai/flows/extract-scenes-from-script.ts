...
Always validate JSON internally before returning.

Never add meta-comments.

Always include location, tone, and style fields (empty if not found).

Return a single clean JSON block suitable for backend use.
  `;
